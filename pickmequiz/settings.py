"""
Django settings for pickmequiz project.
...
SECRET_KEY = 'django-insecure-b9@lcij_rg)jka4r@j!onq*mogctprfa0y^w=tw+%r#3#$4@(b'
...
WSGI_APPLICATION = 'pickmequiz.wsgi.application'
